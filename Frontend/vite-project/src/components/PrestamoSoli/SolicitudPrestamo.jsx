...
function FormularioPrestamo() {
  ...
  const cuotaMensual =
    montoFinal *
    (tasaInteresMensual / (1 - Math.pow(1 + tasaInteresMensual, -plazo)));
    ...
    <div className="Prestamo">
      <div className="formulario">
        ...
        <div >
          ...
          <p>
            Tasa de interés mensual: {(tasaInteresMensual * 100).toFixed(2)}%
          </p>
        ...
        <button
          onClick={() =>
            console.log(`Solicitando préstamo de $${monto} a ${plazo} meses`)
          }
        >
          Solicitar Préstamo
        </button>
