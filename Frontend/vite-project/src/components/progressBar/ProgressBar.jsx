...
const ProgressBar = ({
  ...
  return (
    <div className={styles.progress_contain}>
      <div className={styles.progress_header}>
        <button
          className={`${styles.previous_btn} ${
            currentStep > 1 ? "" : styles.invisible
          }`}
      ...
      <div className={styles.progress_bar}>{steps}</div>

      {/*  BORRAR ESTO EN CASO DE USARSE, ES SOLO DE MUESTRA  */}
      <h4 style={{ color: "black", textAlign: "center", margin: "1rem auto" }}>
        Este será el paso: {currentStep}
      </h4>
      {/* ------------------------  */}
      ...
      <div className={styles.progress_footer}>
        {currentStep < totalSteps && (
          <button className={styles.next_btn} onClick={handleNextStep}>
